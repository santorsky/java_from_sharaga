...
public class DeleteLegalInsuranceClientController {
    ...
    void initialize() throws IOException, ClassNotFoundException {
        ...
        legalInsuranceList_1 = WorkingWithFiles.readSaveMLI(legalInsuranceList_1);
        ...
        delete.setOnAction(event -> {
            ...
            myLegalInsuranceList.remove(delNum - 1);

            myLegalInsuranceList = Main.checkLIL(myLegalInsuranceList, delNum-1);
