...
public class AddPhysicalInsuranceController {
    ...
    void initialize() {
        ...
        ObservableList<String> insurantList = FXCollections.observableArrayList("ADULT", "MINOR");
        age.setItems(insurantList);

        Label lbl = new Label();

        age.setOnAction(event -> {lbl.setText(age.getValue());
        ...
        add.setOnAction(event -> {
            ...
            PhysicalInsurance PI = new PhysicalInsurance(insuranceName, type, months, sum);
            Main.checkRatePhysical(PI);
