...
public class DeletePhysicalInsuranceClientController {
    ...
    void initialize() throws IOException, ClassNotFoundException {
        ...
        physicalInsuranceList_1 = WorkingWithFiles.readSaveMPI(physicalInsuranceList_1);
        ...
        delete.setOnAction(event -> {
            ...
            myPhysicalInsuranceList.remove(delNum - 1);

            myPhysicalInsuranceList = Main.checkPIL(myPhysicalInsuranceList, delNum-1);
